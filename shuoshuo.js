<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/drew233/css/md5.js"></script>
    <script>
    ...
    function savecontent(){
        ...
        if(hash!="7bc3002fc0d6bc095fcb077410ae2443"){
            alert("本页面仅允许站长发布说说");
            return ;
        }
        if(shuoshuo==""){  
    ...
    function seecontent(){
        AV.init({
            appId: "v7RUELXqRXpxactiQlFOa7st-MdYXbMMI",
            appKey: "bUG2OW4oaVi3OKPNiPxGDy8o",
        });
